using Tyuiu.KomarovNA.Sprint0.Task7.V0.Lib;

namespace Tyuiu.KomarovNA.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Комаров Никита Алексеевич | ИИПБ-24-1";
